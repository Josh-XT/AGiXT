...
# Update this line
agent_name, agent_history = agent_selector()

# Add this line to display agent history
if agent_name:  # Only show history if an agent is selected
    st.write(agent_history)
