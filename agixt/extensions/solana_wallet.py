...
class solana_wallet(Extensions):
    ...
    async def send_sol(
        self, from_wallet: str = None, to_wallet: str = "", amount: str = "0.0", memo: str = None
    ):
        """
    ...
    async def get_associated_token_address(self, wallet_address: str, token_mint: str) -> Pubkey:
        """
    ...
    async def create_associated_token_account(self, wallet_address: str = None, token_mint: str = ""):
        """
    ...
    async def send_spl_token(
        ...
        try:
            ...
            source_ata = await self.get_associated_token_address(from_wallet, token_mint)
    ...
    async def burn_tokens(self, token_mint: str, amount: str, decimals: int = None):
        ...
        try:
            ...
            # Get token account
            token_account = await self.get_associated_token_address(self.wallet_address, token_mint)
    ...
    async def get_all_token_balances(self, wallet_address: str = None):
        ...
        try:
            ...
            for account in response.value:
                try:
                    balance_response = await self.client.get_token_account_balance(account.pubkey)
    ...
    async def stake_sol(self, amount: str, validator: str = None):
        ...
        try:
            ...
            rent_response = await self.client.get_minimum_balance_for_rent_exemption(200)
            ...
            initialize_ix = Instruction(
                ...
                accounts=[
                    AccountMeta(pubkey=stake_keypair.pubkey(), is_signer=False, is_writable=True),
            ...
            delegate_ix = Instruction(
                ...
                accounts=[
                    ...
                    AccountMeta(pubkey=Pubkey.from_string("Stake11111111111111111111111111111111111111"), is_signer=False, is_writable=False),
                    AccountMeta(pubkey=from_pubkey, is_signer=True, is_writable=False),
                ],
    ...
    async def get_stake_accounts(self, wallet_address: str = None):
        ...
        try:
            ...
            response = await self.client.get_program_accounts(
                STAKE_PROGRAM_ID,
                filters=[
                    {"memcmp": {"offset": 12, "bytes": wallet_address}}
                ]
            )
    ...
    async def request_airdrop(self, amount_sol: float = 1.0, wallet_address: str = None):
        """
    ...
    async def get_jupiter_swap_quote(
        ...
        try:
            ...
            response = requests.get(
                f"{self.JUPITER_API_BASE_URL}/quote", 
                params=params
            )
    ...
    async def execute_jupiter_swap(
        ...
        if not self.wallet_address or not self.wallet_keypair:
            return "No wallet initialized. Please initialize with SOLANA_WALLET_API_KEY."
        ...
        try:
            ...
            swap_response = requests.post(
                f"{self.JUPITER_API_BASE_URL}/swap", 
                json=swap_request
            )
    ...
    async def get_transaction_info(self, tx_signature: str):
        ...
        try:
            ...
            sig = Signature.from_string(tx_signature) if isinstance(tx_signature, str) else tx_signature
            ...
            if response.value:
                ...
                tx_info = {
                    ...
                    "status": "Success" if response.value.meta and response.value.meta.err is None else "Failed"
                }
    ...
    async def set_priority_fee_instruction(self, micro_lamports: int = 1000) -> Instruction:
        """
    ...
    async def get_priority_fee_estimate(self):
        ...
        try:
            ...
            return {"suggested_priority_fee": 1000, "unit": "micro_lamports", "note": "Default estimate"}
        except Exception as e:
    ...
    async def create_token_mint(
        ...
        try:
            ...
            freeze_auth_pubkey = Pubkey.from_string(freeze_authority) if freeze_authority else None
    ...
    async def create_multisig_account(self, signers: List[str], threshold: int):
        ...
        try:
            ...
            rent_response = await self.client.get_minimum_balance_for_rent_exemption(space)
            rent_lamports = rent_response
            ...
            init_multisig_keys = [
                AccountMeta(pubkey=multisig_keypair.pubkey(), is_signer=False, is_writable=True),
                AccountMeta(pubkey=Pubkey.from_string("SysvarRent111111111111111111111111111111111"), is_signer=False, is_writable=False),
            ]
            ...
            for signer in signers:
                init_multisig_keys.append(
                    AccountMeta(pubkey=Pubkey.from_string(signer), is_signer=False, is_writable=False)
                )
    ...
    async def simulate_transaction(self, instructions: List[Instruction], signers: List[str] = None):
        """
    ...
    async def create_address_lookup_table(self, authority: str = None):
        ...
        try:
            ...
            lookup_table_address, bump = Pubkey.find_program_address(seeds, LOOKUP_TABLE_PROGRAM_ID)
            ...
            create_keys = [
                AccountMeta(pubkey=lookup_table_address, is_signer=False, is_writable=True),
                AccountMeta(pubkey=authority_pubkey, is_signer=True, is_writable=False),
    ...
    async def extend_address_lookup_table(self, table_address: str, new_addresses: List[str]):
        """
        ...
        try:
            ...
            extend_keys = [
                ...
                AccountMeta(pubkey=payer, is_signer=True, is_writable=False),  # Authority
                AccountMeta(pubkey=payer, is_signer=True, is_writable=True),
                AccountMeta(pubkey=SYS_PROGRAM_ID, is_signer=False, is_writable=False),
            ]
