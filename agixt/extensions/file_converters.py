...
class file_converters(Extensions):
    ...
    def __init__(self, **kwargs):
        ...
        self.WORKING_DIRECTORY = (
            kwargs.get("conversation_directory", os.path.join(os.getcwd(), "WORKSPACE"))
        )
    ...
    async def convert_to_pdf(self, markdown_content: str, output_file: str) -> str:
        ...
        try:
            ...
            temp_md = os.path.join(self.WORKING_DIRECTORY, f"{os.path.splitext(output_file)[0]}.md")
        ...
        try:
            ...
            for line in lines:
                if '|' in line:
                    ...
                    if len(current_table) > 1:  # Only keep tables with at least header and one row
