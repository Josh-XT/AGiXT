...
class KoboldProvider:
    def __init__(
        ...
        **kwargs,
        ...
        self.requirements = []
        self.AI_PROVIDER_URI = AI_PROVIDER_URI if AI_PROVIDER_URI else "http://host.docker.internal:5001"
        ...
        self.SAMPLER_FULL_DETERMINISM = SAMPLER_FULL_DETERMINISM if SAMPLER_FULL_DETERMINISM else False
        ...
        self.DISABLE_INPUT_FORMATTING = DISABLE_INPUT_FORMATTING if DISABLE_INPUT_FORMATTING else True
        self.DISABLE_OUTPUT_FORMATTING = DISABLE_OUTPUT_FORMATTING if DISABLE_OUTPUT_FORMATTING else True
    ...
    async def inference(self, prompt, tokens: int = 0):
        ...
        def is_koboldcpp() -> bool:
            response = requests.get(f"{self.AI_PROVIDER_URI}/api/extra/version").json()["result"]
