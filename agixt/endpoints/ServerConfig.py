...
BOT_PLATFORM_SETTINGS = {
    ...
    "outreach": {
        ...
        "oauth_provider": None,
        "description": "Zero-config growth outreach bot. No API keys needed — uses the agent's built-in web browser to monitor social media for warm leads, mine competitor reviews, generate content, and manage outreach. Just enable it, tell it your product name, and it starts working.",
        "allowlist_type": None,
