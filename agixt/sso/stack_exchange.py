...
- STACKEXCHANGE_CLIENT_ID: Stack Exchange OAuth client ID
- STACKEXCHANGE_CLIENT_SECRET: Stack Exchange OAuth client secret

Required APIs

Follow the links to confirm that you have the APIs enabled,
then add the `STACKEXCHANGE_CLIENT_ID` and `STACKEXCHANGE_CLIENT_SECRET` environment variables to your `.env` file.

Required scopes for Stack Exchange OAuth
