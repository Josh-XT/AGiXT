...
class CompanyTelegramBot:
    ...
    def __init__(
        ...
        logger.info(f"Initialized Telegram bot for company {company_name} ({company_id})")
    ...
    async def _send_message(
        ...
        try:
            ...
            if len(text) > 4096:
                ...
                for chunk in chunks:
                    await self._send_message(chat_id, chunk, reply_to_message_id, parse_mode)
                return True
    ...
    async def _handle_command(
        ...
        if cmd == "/help" or cmd == "/start":
            ...
            current = self._get_selected_agent(user_id) or await self._get_default_agent()
            ...
            current_agent = self._get_selected_agent(user_id) or await self._get_default_agent()
    ...
    async def _process_message(self, message: dict):
        ...
        try:
            ...
            logger.info(f"Processing message from {username or user_id}: {text[:100]}...")
