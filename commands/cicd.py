...
class cicd(Commands):
    ...
    def evaluate_code(self, code: str, agent_name: str = "Agent-LLM") -> List[str]:
        args = [code]
        ...
        return AgentLLM(agent_name).run(prompt)

    def analyze_pull_request(
        self, pr_url: str, agent_name: str = "Agent-LLM"
    ) -> List[str]:
        args = [pr_url]
    ...
    def perform_automated_testing(
        self, test_url: str, agent_name: str = "Agent-LLM"
    ) -> List[str]:
        args = [test_url]
    ...
    def improve_code(
        self, suggestions: List[str], code: str, agent_name: str = "Agent-LLM"
    ) -> str:
    ...
    def run_ci_cd_pipeline(self, repo_url: str, agent_name: str = "Agent-LLM") -> str:
        args = [repo_url]
